...
import { getTodo, updateTodo } from '../ultis/ultis'
        ...
        if (this.state.isEdit) {
            return (
                <div className='Todolist'>
                    <TodoEditor {...this.state.selected} index={this.state.selectedind} cancle={this.cancleEditor} save={this.save} />
                </div>
            )
        }
        return (
            <div className="Todolist" >
                {
                    this.state.todos.map((todo, index) => {
                        return <Todo {...todo} key={index} edit={() => this.editTodo(todo, index)} />
                    })
                }
                <div className='add'>
